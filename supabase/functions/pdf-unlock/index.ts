...
serve(async (req) => {
  ...
  try {
    ...
    console.log("PDF Unlock function called with:", { 
      filePaths, 
    ...
    const resultUrl = `https://unlocked-pdf-demo.example/unlocked_${Date.now()}.pdf`;
    ...
    console.error("Error in pdf-unlock function:", error);
